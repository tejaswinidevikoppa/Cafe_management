...
router.get('/get',auth.authenticationToken,(req,res)=>{
    var query = "select p.id,p.name,p.description,p.price,p.status,c.id as categoryId,c.name as categoryName from product p INNER JOIN category c where p.categoryId=c.id";
